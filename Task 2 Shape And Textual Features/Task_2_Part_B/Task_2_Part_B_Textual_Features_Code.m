...
title('Histogram of red channel\_white ball\_contrast');
xlabel('Contrast');
ylabel('Frequency');
subplot(2,3,3);
histogram(red_orange_contrast_all,num_bins,'FaceColor', [1 0 0]);
title('Histogram of red channel\_orange ball\_contrast');
xlabel('Contrast');
ylabel('Frequency');
subplot(2,3,4);
histogram(red_contrast_all_range,num_bins,'FaceColor', [1 1 0]);
title('Histogram of red channel\_yellow ball\_contrast\_range');
xlabel('Contrast');
ylabel('Frequency');
subplot(2,3,5);
histogram(red_white_contrast_all_range,num_bins,'FaceColor', [0/255, 21/255, 71/255]);
title('Histogram of red channel\_white ball\_contrast\_range');
xlabel('Contrast');
ylabel('Frequency');
subplot(2,3,6);
histogram(red_orange_contrast_all_range,num_bins,'FaceColor', [1 0 0]);
title('Histogram of red channel\_orange ball\_contrast\_range');
xlabel('Contrast');
ylabel('Frequency');
...
title('Histogram of green channel\_yellow ball\_correlation');
xlabel('Correlation');
ylabel('Frequency');
subplot(2,3,2);
histogram(green_white_correlation_all,num_bins,'FaceColor', [0/255, 21/255, 71/255]);
title('Histogram of green channel\_white ball\_correlation');
xlabel('Correlation');
ylabel('Frequency');
subplot(2,3,3);
histogram(green_orange_correlation_all,num_bins,'FaceColor', [1 0 0]);
title('Histogram of green channel\_orange ball\_correlation');
xlabel('Correlation');
ylabel('Frequency');
subplot(2,3,4);
histogram(green_correlation_all_range,num_bins,'FaceColor', [1 1 0]);
title('Histogram of green channel\_yellow ball\_correlation\_range');
xlabel('Correlation');
ylabel('Frequency');
subplot(2,3,5);
histogram(green_white_correlation_all_range,num_bins,'FaceColor', [0/255, 21/255, 71/255]);
title('Histogram of green channel\_white ball\_correlation\_range');
xlabel('Correlation');
ylabel('Frequency');
subplot(2,3,6);
histogram(green_orange_correlation_all_range,num_bins,'FaceColor', [1 0 0]);
title('Histogram of green channel\_orange ball\_correlation\_range');
xlabel('Correlation');
ylabel('Frequency');
...
title('Histogram of blue channel\_yellow ball\_asm');
xlabel('ASM');
ylabel('Frequency');
subplot(2,3,2);
histogram(blue_white_asm_all,num_bins,'FaceColor', [0/255, 21/255, 71/255]);
title('Histogram of blue channel\_white ball\_asm');
xlabel('ASM');
ylabel('Frequency');
subplot(2,3,3);
histogram(blue_orange_asm_all,num_bins,'FaceColor', [1 0 0]);
title('Histogram of blue channel\_orange ball\_asm');
xlabel('ASM');
ylabel('Frequency');
subplot(2,3,4);
histogram(blue_asm_all_range,num_bins,'FaceColor', [1 1 0]);
title('Histogram of blue channel\_yellow ball\_asm\_range');
xlabel('ASM');
ylabel('Frequency');
subplot(2,3,5);
histogram(blue_white_asm_all_range,num_bins,'FaceColor', [0/255, 21/255, 71/255]);
title('Histogram of blue channel\_white ball\_asm\_range');
xlabel('ASM');
ylabel('Frequency');
subplot(2,3,6);
histogram(blue_orange_asm_all_range,num_bins,'FaceColor', [1 0 0]);
title('Histogram of blue channel\_orange ball\_asm\_range');
xlabel('ASM');
ylabel('Frequency');
